	...
	**/
	...
	var ApexChartsComponent = {
	  ...
	  beforeMount: function beforeMount() {
	    window.ApexCharts = apexcharts_common;
	  },
	  ...
	  methods: {
	    init: function init() {
	      ...
	      this.chart = new apexcharts_common(this.$el, config);
	      this.chart.render();
	    },
	...
	VueApexCharts.install = function (Vue) {
	  ...
	  Vue.ApexCharts = apexcharts_common;
	  window.ApexCharts = apexcharts_common; // add the instance method
